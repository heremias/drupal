...
[![Build Status](https://travis-ci.org/heremias/apache-php.svg?branch=master)](https://travis-ci.org/heremias/apache-php) [![](https://images.microbadger.com/badges/image/heremias/apache-php.svg)](https://microbadger.com/images/heremias/apache-php "Get your own image badge on microbadger.com")

This project is composed of three main parts:

  - **Ansible project**: This project is maintained on GitHub: [heremias/apache-php](https://github.com/heremias/apache-php). Please file issues, support requests, etc. against this GitHub repository.
  - **Docker Hub Image**: If you just want to use [the `heremias/apache-php` Docker image](https://hub.docker.com/r/heremias/apache-php/) in your project, you can pull it from Docker Hub.
...
If you want to use the `heremias/php-apache` image from Docker Hub, you don't need to install or use this project at all. You can quickly build a PHP container locally with:
...
You can also wrap up that configuration in a `Dockerfile` and/or a `docker-compose.yml` file if you want to keep things simple. For example:
    ...
    services:
      php-apache:
        image: heremias/apache-php:latest
